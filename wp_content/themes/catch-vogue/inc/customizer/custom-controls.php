 ...
 */
function catch_vogue_custom_controls( $wp_customize ) {
	// Custom control for Important Links.
	class Catch_Vogue_Important_Links extends WP_Customize_Control {
		...
		public function render_content() {
			...
			$important_links = array(
				'theme_instructions' => array(
					'link'  => esc_url( 'https://catchthemes.com/themes/catch-vogue/#theme-instructions' ),
					'text'  => esc_html__( 'Theme Instructions', 'catch-vogue' ),
					),
				'support' => array(
					'link'  => esc_url( 'https://catchthemes.com/support/' ),
					'text'  => esc_html__( 'Support', 'catch-vogue' ),
					),
				'changelog' => array(
					'link'  => esc_url( 'https://catchthemes.com/changelogs/catch-vogue-theme/' ),
					'text'  => esc_html__( 'Changelog', 'catch-vogue' ),
					),
				'facebook' => array(
					'link'  => esc_url( 'https://www.facebook.com/catchthemes/' ),
					'text'  => esc_html__( 'Facebook', 'catch-vogue' ),
					),
				'twitter' => array(
					'link'  => esc_url( 'https://twitter.com/catchthemes/' ),
					'text'  => esc_html__( 'Twitter', 'catch-vogue' ),
					),
				'gplus' => array(
					'link'  => esc_url( 'https://plus.google.com/+Catchthemes/' ),
					'text'  => esc_html__( 'Google+', 'catch-vogue' ),
					),
				'pinterest' => array(
					'link'  => esc_url( 'http://www.pinterest.com/catchthemes/' ),
					'text'  => esc_html__( 'Pinterest', 'catch-vogue' ),
					),
			);
	...
	class Catch_Vogue_Multi_Cat extends WP_Customize_Control {
		...
		public function render_content() {
			$dropdown = wp_dropdown_categories(
				array(
					...
					'hide_if_empty'    => false,
					'show_option_all'  => esc_html__( 'All Categories', 'catch-vogue' ),
				)
			);
			...
			echo '<p class="description">' . esc_html__( 'Hold down the Ctrl (windows) / Command (Mac) button to select multiple options.', 'catch-vogue' ) . '</p>';
		}
	}

	// Custom control for any note, use label as output description.
	class Catch_Vogue_Note_Control extends WP_Customize_Control {
	...
	class Catch_Vogue_Toggle_Control extends WP_Customize_Control {
		public $type = 'light';
