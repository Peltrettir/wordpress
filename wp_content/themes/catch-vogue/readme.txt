...
= 1.5 (Released: August 26, 2020) =
* Bug Fixed: Blog page title issue
* Updated: Readme
...
= 1.3 (Released: February 22, 2020) =
* Bug Fixed: Custom logo max-width issue
* Bug Fixed: HTML issue in searchform.php

= 1.2.9 (Released: January 29, 2020) =
* Bug Fixed: Typo issue

= 1.2.8 (Released: January 20, 2020) =
* Removed: Demo Importer

= 1.2.7 (Released: January 15, 2020) =
* Bug Fixed: h1 tag issue

= 1.2.6 (Released: December 10, 2019) =
* Bug Fixed: Comment Form issue on Safari browser
* Bug Fixed: Site title word wrap issue

= 1.2.5 (Released: November 30, 2019) =
* Bug Fixed: Scroll down issue
* Bug Fixed: Little bugs in style.css
